...
class AutoloaderTest extends \WP_Mock\Tools\TestCase
{
    ...
    */
    ...
    public function testLoadPlugins()
    {
        ...
        \WP_Mock::userFunction(
            'get_site_option',
            ['args' => 'kcms_autoloader', 'return' => false]
        );
        \WP_Mock::userFunction(
            'update_site_option',
            ['args' => ['kcms_autoloader', \WP_Mock\Functions::type('array')], 'return' => true]
        );

        // can't test this due to side-effects in constructor
        // https://github.com/kubeeapp/kcms-autoloader/issues/4
